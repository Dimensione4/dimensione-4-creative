  ...
  return (
    <Layout>
      <SEO
        ...
        description={
          isItalian
            ? "Termini e Condizioni di Dimensione4. Leggi le condizioni di utilizzo del sito."
            : "Terms and Conditions of Dimensione4. Read the terms of use for the website."
        }
          ...
          <article className="prose prose-lg dark:prose-invert max-w-none">
            ...
            {isItalian ? (
              <>
                ...
                <p>
                  Dimensione4 offre servizi di consulenza e sviluppo web, tra
                  cui:
                </p>
                <ul>
                ...
                <p>
                  Tutti i contenuti presenti su questo sito (testi, immagini,
                  loghi, grafica, codice sorgente) sono protetti da diritto
                  d'autore e sono di proprietà di Dimensione4 o dei rispettivi
                  titolari.
                </p>
                <p>
                  È vietata la riproduzione, distribuzione o modifica dei
                  contenuti senza autorizzazione scritta.
                </p>

                <h2>4. Limitazione di Responsabilità</h2>
                <p>
                  Dimensione4 si impegna a mantenere il sito aggiornato e
                  funzionante, tuttavia non garantisce:
                </p>
                <ul>
                ...
                <p>
                  Questo sito può contenere link a siti web esterni. Dimensione4
                  non è responsabile del contenuto o delle pratiche sulla
                  privacy di tali siti.
                </p>

                <h2>6. Modulo di Contatto</h2>
                <p>
                  Utilizzando il modulo di contatto, l'utente garantisce che le
                  informazioni fornite sono veritiere e si impegna a non
                ...
                <p>
                  Le prenotazioni effettuate tramite il sistema integrato
                  (Calendly) sono soggette alle condizioni del servizio di
                  prenotazione. Dimensione4 si riserva il diritto di annullare o
                  riprogrammare appuntamenti con ragionevole preavviso.
                </p>

                <h2>8. Modifiche ai Termini</h2>
                <p>
                  Dimensione4 si riserva il diritto di modificare questi Termini
                  e Condizioni in qualsiasi momento. Le modifiche saranno
                  efficaci dalla data di pubblicazione su questa pagina.
                </p>

                <h2>9. Legge Applicabile e Foro Competente</h2>
                <p>
                  I presenti Termini e Condizioni sono regolati dalla legge
                  italiana. Per qualsiasi controversia sarà competente il Foro
                  del luogo di residenza del consumatore, ove applicabile, o in
                  alternativa il Foro di Bergamo.
                </p>

                <h2>10. Contatti</h2>
                <p>
                  Per qualsiasi domanda relativa a questi Termini e Condizioni,
                  contattaci all'indirizzo: dariomarcobellini@dimensione4.it
                </p>
              </>
            ) : (
              <>
                ...
                <p>
                  Use of this website implies full acceptance of these Terms and
                  Conditions.
                </p>

                <h2>2. Services Offered</h2>
                <p>
                  Dimensione4 offers web consulting and development services,
                  including:
                </p>
                <ul>
                ...
                <p>
                  This site may contain links to external websites. Dimensione4
                ...
                <p>
                  By using the contact form, users guarantee that the
                  information provided is truthful and commit not to use the
                  service for:
                </p>
                <ul>
                ...
                <p>
                  ...
                  subject to the booking service conditions. Dimensione4
                  reserves the right to cancel or reschedule appointments with
                  reasonable notice.
                </p>

                <h2>8. Changes to Terms</h2>
                <p>
                  Dimensione4 reserves the right to modify these Terms and
                  Conditions at any time. Changes will be effective from the
                  date of publication on this page.
                </p>

                <h2>9. Applicable Law and Jurisdiction</h2>
                <p>
                  These Terms and Conditions are governed by Italian law. For
                  any dispute, the competent court shall be that of the
                  consumer's place of residence, where applicable, or
                  alternatively the Court of Bergamo.
                </p>

                <h2>10. Contact</h2>
                <p>
                  For any questions about these Terms and Conditions, contact us
                  at: dariomarcobellini@dimensione4.it
                </p>
              </>
            )}
          </article>
