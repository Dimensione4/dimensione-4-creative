              ...
              {isItalian ? (
                <>
                  ...
                  <p>
                    ...
                    sul tuo dispositivo quando visiti un sito web. Sono
                    ampiamente utilizzati per far funzionare i siti web in modo
                    più efficiente e fornire informazioni ai proprietari del
                    sito.
                  </p>
                  ...
                  <p>
                    Questi cookie ci permettono di analizzare l'utilizzo del
                    sito per migliorarne le funzionalita. Vengono attivati solo
                    con il tuo consenso.
                  </p>

                  <h2>3. Cookie di Terze Parti</h2>
                  <p>
                    Il nostro sito potrebbe utilizzare servizi di terze parti
                    che installano cookie:
                  </p>
                  <ul>
                    <li>
                ...
                <>
                  ...
                  <p>
                    These cookies allow us to analyze website usage to improve
                    its functionality. They are only activated with your
                    consent.
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Google reCAPTCHA:</strong> for form spam
                      protection
                    </li>
                  </ul>
                  ...
                  <p>
                    ...
                    management banner. You can change your preferences at any
                    time by clicking the "Manage Cookies" link in the site
                    footer.
                  </p>
