  ...
  return (
    <Layout>
      <SEO 
        ...
        description={isItalian ? "Informativa sulla privacy di Dimensione4. Scopri come trattiamo i tuoi dati personali." : "Privacy Policy of Dimensione4. Learn how we handle your personal data."}
          ...
          <article className="prose prose-lg dark:prose-invert max-w-none">
            ...
            {isItalian ? (
              <>
                ...
                <ul>
                  <li><strong>Dati di contatto:</strong> nome, indirizzo email, sito web (opzionale), messaggio</li>
                  <li><strong>Dati di navigazione:</strong> indirizzo IP, tipo di browser, sistema operativo, pagine visitate</li>
                  <li><strong>Cookie:</strong> cookie tecnici e, previo consenso, cookie analitici</li>
                </ul>
                ...
                <ul>
                  <li><strong>Consenso:</strong> per l'invio di comunicazioni e l'utilizzo di cookie non tecnici</li>
                  <li><strong>Esecuzione di un contratto:</strong> per rispondere alle richieste di servizi</li>
                  <li><strong>Legittimo interesse:</strong> per garantire la sicurezza del sito</li>
                </ul>

                <h2>5. Periodo di Conservazione</h2>
                <p>
                  I dati raccolti tramite il modulo di contatto vengono conservati per il tempo necessario 
                  a rispondere alla richiesta e successivamente per un periodo massimo di 24 mesi.
                </p>
                ...
                <p>
                  Per esercitare questi diritti, contattaci all'indirizzo: info@dimensione4.it
                </p>
                ...
                <p>
                  ...
                  puoi contattarci all'indirizzo: info@dimensione4.it
                </p>
              </>
            ) : (
              <>
                ...
                <p>
                  Personal data collected through this website includes:
                </p>
                <ul>
                  <li><strong>Contact data:</strong> name, email address, website (optional), message</li>
                  <li><strong>Navigation data:</strong> IP address, browser type, operating system, pages visited</li>
                  <li><strong>Cookies:</strong> technical cookies and, with consent, analytics cookies</li>
                </ul>
                ...
                <ul>
                  <li><strong>Consent:</strong> for sending communications and using non-technical cookies</li>
                  <li><strong>Contract performance:</strong> to respond to service requests</li>
                  <li><strong>Legitimate interest:</strong> to ensure website security</li>
                </ul>

                <h2>5. Retention Period</h2>
                <p>
                  Data collected through the contact form is retained for the time necessary 
                  to respond to the request and subsequently for a maximum period of 24 months.
                </p>

                <h2>6. Data Sharing</h2>
                <p>
                  Your personal data is not sold to third parties. It may be shared with:
                </p>
                <ul>
                ...
                <p>
                  To exercise these rights, contact us at: info@dimensione4.it
                </p>

                <h2>8. Security</h2>
                <p>
                  We implement appropriate technical and organizational security measures to protect 
                  your personal data from unauthorized access, loss, or destruction.
                </p>
                ...
                <p>
                  ...
                  you can contact us at: info@dimensione4.it
                </p>
              </>
            )}
          </article>
